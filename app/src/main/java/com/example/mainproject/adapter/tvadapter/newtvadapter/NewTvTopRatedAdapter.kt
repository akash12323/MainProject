package com.example.mainproject.adapter.tvadapter.newtvadapter
...
class NewTvTopRatedAdapter(val user:List<TvTopRated>):
    RecyclerView.Adapter<NewTvTopRatedAdapter.ItemVieHolder>(){

    var onItemClick:((user: TvTopRated)->Unit)? = null
