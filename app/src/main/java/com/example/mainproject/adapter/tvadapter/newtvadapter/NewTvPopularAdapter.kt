...
class NewTvPopularAdapter(val user:List<TvPopular>):
    RecyclerView.Adapter<NewTvPopularAdapter.ItemVieHolder>(){

    var onItemClick:((user: TvPopular)->Unit)? = null
